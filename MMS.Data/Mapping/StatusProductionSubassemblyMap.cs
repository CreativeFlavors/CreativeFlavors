...
{
    public class StatusProductionSubassemblyMap : EntityTypeConfiguration<StatusProductionSubassembly>
    {
        public StatusProductionSubassemblyMap()
        {
            HasKey(t => t.StatusId);
            ...
            ToTable("statusproductionsubassembly");
        }
    }
}
