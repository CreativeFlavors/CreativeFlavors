...
{
    public class ProductionsubassemblyMap : EntityTypeConfiguration<Productionsubassembly>
    {
        public ProductionsubassemblyMap() 
        {
            ...
            Property(t => t.ProductionSubassemblyStatus).HasColumnName("productionsubassemblystatus");
