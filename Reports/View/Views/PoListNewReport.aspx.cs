...
{
    public partial class PoListNewReport : System.Web.UI.Page
    {
...

        {
            ...
            try
            {
                ...
                PoListnew dsRpt = new PoListnew();
                // DataSet_.PoList dsRpt = new DataSet_.PoList();
                DataTable dt = new DataTable();
                dt = dsRpt.Tables[0];
                da.Fill(dsRpt, "spPOListNew");
                crystalReport.Load(Server.MapPath("~/ReportPage/PoList.rpt"));
                ...
                PoListNewViewer.ReportSource = crystalReport;
                PoListNewViewer.DataBind();
