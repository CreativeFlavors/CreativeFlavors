...
{
    public partial class StockStatementwithPCs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                StockStatementwithPCsViewer.ID = storename+" StockStatementReport";
                GC.Collect();
        ...
        public void LoadReport()
        {
            ...
            try
            {
                ...
                dt = dsRpt.Tables[0];
                    ...
                    crystalReport.Load(Server.MapPath("~/ReportPage/StockManagementwithPCs.rpt"));
                ...
                StockStatementwithPCsViewer.ReportSource = crystalReport;
                StockStatementwithPCsViewer.DataBind();
