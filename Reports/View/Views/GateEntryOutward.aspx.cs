...
{
    public partial class GateEntryOutward : System.Web.UI.Page
    {
        ReportDocument crystalReport = new ReportDocument();
        string From = "", To = "", url = "", Purpose = "", ReturnType = "",SupplierId= "", MaterialNameId = "",StoresName = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["FromDate"] != null && Request.QueryString["ToDate"] != null)
                {
                    ...
                    Session["StoresName"] = Decryption.Decrypt(HttpUtility.UrlDecode(Request.QueryString["StoresName"]));
                }
            ...
            try
            {
                ...
                StoresName = Session["StoresName"].ToString();
        ...
        public void LoadReport()
        {
            ...
            try
            {
                ...
                cmd.Connection = Con;
                Con.Open();
                cmd.CommandText = "spGateEntryOutward";
                ...
                cmd.Parameters.AddWithValue("@StoresName", StoresName);

                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.SelectCommand.CommandTimeout = 0;
                Reports.DataSet_.GateEntryOutward rpt = new Reports.DataSet_.GateEntryOutward();
                da.Fill(rpt, "spGateEntryOutward");
                DataTable dt = new DataTable();
                dt = rpt.Tables[0];
                crystalReport.Load(Server.MapPath("~/ReportPage/GateEntryOutwardReport.rpt"));
                ...
                GateEntryOutwardReportViewer.ReportSource = crystalReport;
                GateEntryOutwardReportViewer.DataBind();
                //Email.SendEmail(crystalReport, "GateEntry Outward Report", "GateEntry Outward Report");
            }
            catch (Exception Ex)
            {
