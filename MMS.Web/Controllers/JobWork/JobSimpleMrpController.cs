...
namespace MMS.Web.Controllers.JobWork
{
    ...
    [CustomFilter]
    public class JobSimpleMrpController : Controller
    {
        //
        // GET: /JobSimpleMrp/
        ...
        public ActionResult JobSimpleMrp(SimpleMRPModel model)
        {            
            return View("~/Views/Jobwork/Job_Master/JobWorkSimpleMRP/JobWorkSimpleMRP.cshtml", model);
        }

        public ActionResult JobSimpleMrpList()
        {
            model.simpleMRPList = simpleMRPManager.Get();
            return PartialView("~/Views/Jobwork/Job_Master/JobWorkSimpleMRP/Partial/JobWorkSimpleMRPGrid.cshtml", model);
        }

        [HttpPost]
        public ActionResult JobWorkSimpleMRPDetails(int SimpleMRPID)
        {   
            ...
            if (simpleMRP != null)
            {
                ...
                model.LotNO = simpleMRP.LotNO.Value;
                ...
                model.JobWork = simpleMRP.JobWork;
            ...
            else
            {
                ...
                model.MRPCode = simpleMRP.MRPNO.ToString();
            }
            return PartialView("~/Views/Jobwork/Job_Master/JobWorkSimpleMRP/Partial/JobWorkSimpleMRPDetails.cshtml", model);
        }

        public ActionResult GetBuyerWithWeekNO(int BuyerName)
        {
        ...
        public ActionResult JobWorkSimpleMRPModelWithDetails(SimpleMRPModel model)
        {
            List<SelectListItem> listBoxItem = new List<SelectListItem>();
            ImportIOManager importIOManager = new ImportIOManager();
            List<ImportIO> importList = new List<ImportIO>();
            ...
            //return View(model);
            return View("~/Views/Jobwork/Job_Master/JobWorkSimpleMRP/JobWorkSimpleMRPModelWithDetails.cshtml", model);
        }
        ...
        public ActionResult SimpleMRPSave(SimpleMRPModel Model)
        {
            ...
            simpleMRP.JobWork = Model.JobWork;
        ...
        public ActionResult Importexcel(HttpPostedFileBase upload, SimpleMRPModel model_)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (upload != null && upload.ContentLength > 0)
                {
                    ...
                    simpleMRP.JobWork = model_.JobWork;
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            return RedirectToAction("JobWorkSimpleMRPModelWithDetails");
                        }
                    ...
                    return RedirectToAction("JobWorkSimpleMRPModelWithDetails", model_);
                }
                else
                {
