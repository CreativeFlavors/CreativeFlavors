...
{
    public class JobLeather_leatherModel
    {
        ...
        public List<JobLeather_leatherMaster> JobLeather_leatherMasterlist { get; set; }
        public List<Job_LetherCode> Job_LetherCode { get; set; }
        public JobApproved_list JobApproved_list { get; set; }
    }
    public class JobApproved_list
    {
